package cz.bloodbear.discordLink.discord;

import cz.bloodbear.discordLink.DiscordLink;
import cz.bloodbear.discordLink.records.RoleEntry;
import cz.bloodbear.discordLink.utils.ConsoleColor;
import cz.bloodbear.discordLink.utils.DatabaseManager;
import cz.bloodbear.discordLink.utils.DiscordUtils;
...
public class DiscordBot extends ListenerAdapter {
    ...
    public void startAutoSync() {
        DiscordLink.getInstance().getServer().getScheduler()
                .buildTask(DiscordLink.getInstance(), this::syncAllRoles)
    ...
    public void syncAllRoles() {
        ...
        if(guild == null) {
            DiscordLink.getInstance().getLogger().warn(ConsoleColor.yellow("Guild not found: " + guildId));
            return;
        }
